...
QUESTIONS = [
    ...
    "孩子是否有过确诊？（多选）：ADHD、抑郁/焦虑、其他、暂无", 
    "为了解决问题，您之前尝试过哪些方式？（多选）：心理咨询、药物治疗、增加严管、上父母课、其他", 
    "您之前尝试的方法没有彻底生效的原因是？（多选）：不落地、不系统、没法坚持、孩子不配合、缺乏专业陪跑", 
    "您目前最迫切想解决的前三个痛点是？（多选）：关系、厌学、专注力差、情绪较大、手机", 
    "如诊断根源在于“家庭系统及认知”，您是否有勇气参与改变？（单选）：有、有，但需指导、比较纠结、只想改孩子", 
    "填完后，您是否愿预约一次专业“全面分析解读”？（单选）：是、否", 
    "如果需投入时间扭转局面，您是否有兴趣了解？（单选）：是、否"
]
