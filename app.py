...
# D. 结果报告页逻辑
    ...
    <div style="
        ...
        width: 75px; 
        height: 75px; 
        border: 3px double rgba(255, 82, 82, 0.8); 
        border-radius: 50%; 
        display: flex; 
        align-items: center; 
        justify-content: center; 
        ...
        <div style="
            ...
            align-items: center; 
            justify-content: center;">
            <span style="color: rgba(255, 82, 82, 0.8); font-size: 10px; font-weight: 900; line-height:1;">专家组</span>
            <span style="color: rgba(255, 82, 82, 0.8); font-size: 15px; font-weight: 900; line-height:1.2;">已认证</span>
        </div>
    </div>
