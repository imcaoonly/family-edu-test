...
<div style="border:2px solid #E8EAF6; background:#FFFFFF; padding:20px; border-radius:20px; box-shadow:0 12px 40px rgba(26,35,126,0.12); text-align:center; margin:10px 0;">
    ...
    <a href="https://work.weixin.qq.com/ca/cawcde91ed29d8de9f" 
       style="text-decoration:none; display:block; background:#1A237E; color:white; padding:18px; border-radius:15px; font-size:18px; font-weight:bold; -webkit-tap-highlight-color: transparent;">
        👉 立即预约 · 开启家庭重塑
    </a>

    <p style="color:#90A4AE; font-size:11px; margin-top:15px; line-height: 1.5;">
        * 若点击无反应，请<b>长按二维码识别</b>或<b>截屏扫码</b><br>
