...
def prepare_report_data():
    ...
    return {
        ...
        "确诊情况": fmt_internal(ans.get(78)),
        "试过方法": fmt_internal(ans.get(79)),
        "不生效原因": fmt_internal(ans.get(80)),
        "痛点": fmt_internal(ans.get(81)),
        "改变勇气": fmt_internal(ans.get(82)),
        "预约意愿": fmt_internal(ans.get(83)),
        "了解意愿": fmt_internal(ans.get(84)),
