...
# D. 结果报告页逻辑
    ...
    # --- 1. 终极校准：加入印章效果与容器配置 ---
    st.markdown(f"""
<div style="position:relative; background:#FFFFFF; border-radius:12px; box-shadow:0 4px 15px rgba(0,0,0,0.05); border:1px solid #ECEFF1; margin-top:-60px; margin-bottom:20px; overflow:visible; width:100%;">
