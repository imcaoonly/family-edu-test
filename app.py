...
st.markdown("""
    ...
    .home-mask {
        ...
        width: 92%;
        max-width: 550px;
        padding: 40px 25px 30px 25px; /* 底部留白缩小，让按钮更贴合 */
    ...
    .intro-text { font-size: 17px; color: #546E7A; line-height: 1.7; margin-bottom: 10px; border-left: 5px solid #FF7043; padding-left: 20px; }
    ...
    .wx-card { background: #FFFFFF; padding: 30px; border-radius: 24px; border: 2px solid #E8EAF6; box-shadow: 0 12px 40px rgba(26,35,126,0.15); text-align: center; }
