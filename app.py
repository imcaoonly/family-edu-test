...
# D. 结果报告页逻辑
    ...
    # --- 1. 终极校准：全兼容绝对居中版 (强制重置所有干扰) ---
    st.markdown(f"""
<div style="background:#FFFFFF; border-radius:12px; box-shadow:0 4px 15px rgba(0,0,0,0.05); border:1px solid #ECEFF1; margin-top:-60px; margin-bottom:20px; overflow:hidden; width:100%; box-sizing:border-box;">
    <div style="height:5px; background:linear-gradient(90deg, #1A237E, #FF7043); width:100%;"></div>
    
    <div style="padding:25px 0 15px 0; width:100%; text-align:center !important;">
        <div style="color:#90A4AE; font-size:10px; letter-spacing:3px; line-height:1; margin:0 auto 10px auto !important; width:100%; text-align:center !important; display:block !important;">
            REPORT ANALYSIS
        </div>
        
        <div style="width:100%; text-align:center !important; display:block !important; margin:0 auto !important;">
            <span style="color:#1A237E; font-size:32px; font-weight:900; line-height:1.2; display:inline-block; margin:0 auto;">多维报告解析</span>
        </div>
        
        <div style="color:#546E7A; font-size:14px; font-weight:500; line-height:1; margin:10px auto 0 auto !important; width:100%; text-align:center !important; display:block !important;">
            家庭教育十维深度探查
        </div>
    </div>

    <div style="background:#FFFDE7; border-top:1px dashed #FFD54F; border-bottom:1px dashed #FFD54F; margin:0 10px 15px 10px; border-radius:8px; height:85px; display:flex !important; align-items:center !important; justify-content:center !important;">
        <table style="width:100%; border-collapse:collapse; table-layout:fixed; border:none !important; margin:0 !important; background:transparent !important;">
            <tr style="border:none !important; background:transparent !important;">
                <td style="padding-left:15px; text-align:left; vertical-align:middle; border:none !important;">
                    <div style="line-height:1.4;">
                        <p style="color:#E65100; font-size:16px; font-weight:900; margin:0 !important;">📸 截图保存此页</p>
                        <p style="color:#F57C00; font-size:13px; font-weight:800; margin:2px 0 0 0 !important;">1V1 咨询核心凭证</p>
                    </div>
                </td>
                <td style="padding-right:15px; text-align:right; border-left:1px dashed #FFD54F !important; width:42%; vertical-align:middle; border-top:none !important; border-bottom:none !important; border-right:none !important;">
                    <div style="line-height:1.2;">
                        <p style="color:#90A4AE; font-size:11px; font-weight:800; margin:0 !important;">报告编号</p>
                        <p style="color:#1A237E; font-family:monospace; font-size:24px; font-weight:900; margin:2px 0 0 0 !important;">{st.session_state.rid}</p>
                    </div>
                </td>
            </tr>
        </table>
...
<div style="border:2px solid #E8EAF6; background:#FFFFFF; padding:20px; border-radius:20px; box-shadow:0 12px 40px rgba(26,35,126,0.12); text-align:center; margin:10px 0;">
    ...
    <div style="text-align:left; margin:15px 0; background:#F8F9FA; padding:15px; border-radius:15px; border:1px solid #EEE;">
        ...
        <p style="margin:6px 0; color:#455A64; font-size:16px;">
            <b style="color:#C62828; font-weight:bold;">✓</b> 30分钟<b style="color:#FF7043;"> 1V1 </b>深度解析
        </p>
        <p style="margin:6px 0; color:#455A64; font-size:16px;">
