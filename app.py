...
<div style="border:2px solid #E8EAF6; background:#FFFFFF; padding:20px; border-radius:20px; box-shadow:0 12px 40px rgba(26,35,126,0.12); text-align:center; margin:10px 0;">
    ...
    <div style="margin: 10px auto 20px auto; width: 190px; padding: 15px; background: #fff; border-radius: 15px; border: 1px solid #ECEFF1; box-shadow: 0 4px 10px rgba(0,0,0,0.03);">
        <img src="data:image/png;base64,{qr_code_base64}" 
             style="width: 160px; height: 160px; display: block; margin: 0 auto; border-radius: 8px;">
        <p style="color: #FF7043; font-size: 13px; font-weight: 800; margin-top: 10px;">长按上方二维码识别</p>
    </div>

    <div style="margin: 10px auto 20px auto; width: 190px; padding: 15px; background: #fff; border-radius: 15px; border: 1px solid #ECEFF1;">
        <img src="data:image/png;base64,{my_qr_code}" style="width: 160px; height: 160px; display: block; margin: 0 auto; border-radius: 8px;">
        <p style="color: #FF7043; font-size: 13px; font-weight: 800; margin-top: 10px;">长按上方二维码识别</p>
    </div>

    <a href="https://work.weixin.qq.com/ca/cawcde91ed29d8de9f" style="text-decoration:none; display:block; background:#1A237E; color:white; padding:18px; border-radius:15px; font-size:18px; font-weight:bold;">
          👉 立即预约 · 开启家庭重塑
    </a>
