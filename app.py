...
# D. 结果报告页逻辑
    ...
    # --- 1. 终极校准版 (严格对齐，防止代码外露) ---
    st.markdown(f"""
<div style="background:#FFFFFF; border-radius:12px; box-shadow:0 4px 15px rgba(0,0,0,0.05); border:1px solid #ECEFF1; margin-top:-65px; margin-bottom:15px; overflow:hidden; width:100%; text-align:center;">
<div style="height:5px; background:linear-gradient(90deg, #1A237E, #FF7043);"></div>
<div style="padding:15px 0 8px 0; width:100%; display:block;">
<p style="color:#90A4AE; font-size:9px; letter-spacing:2px; margin:0 auto; line-height:1; text-align:center;">REPORT ANALYSIS</p>
<h2 style="color:#1A237E; font-size:32px; font-weight:900; margin:2px 0; line-height:1; text-align:center; width:100%; display:block;">多维报告解析</h2>
...
<table style="width:100%; border-collapse:collapse; table-layout:fixed; border:none; margin:auto;">
<tr style="border:none; vertical-align:middle;">
<td style="text-align:left; padding-left:15px; vertical-align:middle; border:none;">
...
<td style="text-align:right; border-left:1px dashed #FFD54F; padding-right:15px; width:42%; vertical-align:middle; border-top:none; border-bottom:none; border-right:none;">
